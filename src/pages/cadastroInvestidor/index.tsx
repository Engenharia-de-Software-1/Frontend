            ...
            <div className={divGeneral}>
                <div>
                    ...
                    <div className="w-462 mt-5">
                        <Input haslabel label='Nome da startup ou equipe' placeholder='Ex: José da Silva'/>
                        <Input haslabel label='Telefone celular' placeholder='(00) 0 0000-0000' top='mt-10'/>
                        <Input haslabel label='CNPJ' placeholder='00000000000000' top='mt-10'/>
                        <Input haslabel label='Quantidade de membros/sócios' placeholder='0' type='number' min='0' top='mt-10'/>                
                        <Input haslabel label='Formação em  quais áreas (membros/sócios)' placeholder='formações' top='mt-10'/>
